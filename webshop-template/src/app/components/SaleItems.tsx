    ...
    <div className="flex flex-wrap justify-center md:gap-8 mx-auto max-w-7xl md:pt-16 md:pb-16">
      {saleProducts.map((product) => (
        <Link key={product.id} href={`/producten/${product.id}`}>
          <div className="shadow rounded-xl p-4 bg-muted cursor-pointer hover:shadow-lg transition-shadow md:w-94 mt-4 h-[400px] flex flex-col justify-between relative">
            {/* Productafbeelding */}
            <Image
              width={500}
              height={500}
